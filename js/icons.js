...
(function () {
  ...
  App.iconsData = {
    ...
    'accessibility': '<circle cx="16" cy="4" r="1"/><path d="m18 19 1-7-6 1"/><path d="m5 8 3-3 5.5 3-2.36 3.5"/><path d="M4.24 14.5a5 5 0 0 0 6.88 6.03"/><path d="M15 2h6v6"/>',
    ...
    'bike': '<circle cx="18.5" cy="17.5" r="4.5"/><circle cx="5.5" cy="17.5" r="4.5"/><circle cx="15" cy="5" r="1"/><path d="M12 17.5V14l-3-3 4-3 2 3h2"/>',
    ...
    'building': '<rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><line x1="8" y1="6" x2="10" y2="6"/><line x1="16" y1="6" x2="14" y2="6"/><line x1="8" y1="10" x2="10" y2="10"/><line x1="16" y1="10" x2="14" y2="10"/><line x1="8" y1="14" x2="10" y2="14"/><line x1="16" y1="14" x2="14" y2="14"/>',
    ...
    'car': '<path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.2c-.9-.8-2.6-1.8-4.4-1.8H7c-1.8 0-3.5 1-4.4 1.8C1.3 8.6 0 10 0 10s-2.7.4-4.5 1.1C-5.1 11.3-6 12.1-6 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/>',
    ...
    'fish': '<path d="M6.5 12c.94-3.46 4.94-6 8.5-7 3.56.9 7.56 3.54 8.5 7s-4.94 6-8.5 7c-3.56-.9-7.56-3.54-8.5-7Z"/><path d="M18 12v.5"/><path d="M16 17.93A9.77 9.77 0 0 1 8 12a9.77 9.77 0 0 1 8-5.93"/><path d="M7 10.67C7 8 5.58 5.97 2.73 5.5c-1 1.5-1 5 .23 6.5-1.24 1.5-1.24 5-.23 6.5C5.58 18.03 7 16 7 13.33Z"/><path d="M10.46 5.26C10.2 5.88 9.6 7.86 9.6 12s.6 6.12.86 6.74"/>',
    ...
    'git-branch-plus': '<path d="M6 3v12"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M15 6a9 9 0 0 0-9 9"/><path d="M18 15v6"/><path d="M21 18h-6"/>',
    ...
    'ice-cream': '<path d="m7 11 4.44 7.83a2 2 0 0 0 3.12 0L19 11"/><path d="M5 5a7 7 0 0 0 14 0"/><path d="M12 22v-4"/>',
    ...
    'rain': '<path d="M19 16.9A5 5 0 0 0 18 7h-1.26a8 8 0 1 0-11.62 9"/><path d="M11 20v-2"/><path d="M15 20v-2"/><path d="M7 4v-1"/><path d="M11 4v-1"/><path d="M15 4v-1"/><path d="M20 20v-2"/><path d="M4 20v-2"/>',
    ...
    'shield-off': '<path d="m2 2 20 20"/><path d="M5 5a1 1 0 0 0-1 1v7c0 5 3.5 7.5 7.67 8.94a1 1 0 0 0 .67.01c2.35-.82 4.48-1.97 5.9-3.71"/><path d="M9.309 3.652A12.252 12.252 0 0 0 11.24 2.28a1.17 1.17 0 0 1 1.52 0C14.51 3.81 19 5.603 19 12c0 2.08-.47 3.63-1.15 4.88"/>',
    ...
    'sword': '<polyline points="14.5 17.5 3 6V3h3l11.5 11.5"/><line x1="13" y1="19" x2="19" y2="13"/><line x1="16" y1="16" x2="20" y2="20"/><line x1="19" y1="21" x2="21" y2="19"/>',
    ...
    'train': '<rect x="4" y="3" width="16" height="16" rx="2"/><path d="M4 11h16"/><path d="M12 3v8"/><path d="m8 19-2 3"/><path d="m16 19 2 3"/>',
    ...
    'truck': '<path d="M10 17h4V5H2v12h3"/><path d="M20 17h2v-3.34a4 4 0 0 0-1.17-2.83L19 9h-5v8h1"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/>',
    ...
    'warehouse': '<path d="M22 8.35V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8.35A2 2 0 0 1 2.26 6.5l8-3.2a2 2 0 0 1 1.48 0l8 3.2A2 2 0 0 1 22 8.35Z"/><path d="M6 18h12"/><path d="M6 14h12"/><rect width="12" height="12" x="6" y="10"/>',
