...
(function () {
  ...
  App.iconsData = {
    ...
    'angry': '<circle cx="12" cy="12" r="10"/><path d="M16 16s-1.5-2-4-2-4 2-4 2"/><path d="M7.5 8 9 9"/><path d="m14 9 1.5-1"/><path d="M9.5 8h.01"/><path d="M14.5 8h.01"/>',
    ...
    'cake': '<path d="M20 21v-8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8"/><path d="M4 13s2.5-5 4-5 4 5 4 5 2.5-5 4-5 4 5 4 5"/><path d="M12 10V8"/><path d="M8 10V3"/><path d="M16 10V3"/>',
    ...
    'cherry': '<path d="M21 17c0 2.76-4.03 5-9 5s-9-2.24-9-5"/> <path d="M12 17V7"/><path d="M17 11c.88-1.17 2.06-2.6 3-3 .88 1.16 1.94 2.52 3 3"/><path d="M7 11c-.88-1.17-2.06-2.6-3-3-.88 1.16-1.94 2.52-3 3"/>',
    ...
    'diamond': '<path d="M2.7 10.7a1 1 0 0 0 0 1.4l9.2 9.2a1 1 0 0 0 1.4 0l9.2-9.2a1 1 0 0 0 0-1.4l-9.2-9.2a1 1 0 0 0-1.4 0Z"/>',
    'download': '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/>',
    'drum': '<path d="m2 2 8 8"/><path d="m22 2-8 8"/><ellipse cx="12" cy="9" rx="10" ry="5"/><path d="M7 13.4v7.2c0 2.76 2.24 5 5 5s5-2.24 5-5v-7.2"/>',
    'external-link': '<path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/>',
    'eye': '<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>',
    'feather': '<path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5Z"/><path d="M16 8 2 22"/><path d="M17 15H9"/>',
    ...
    'git-branch': '<line x1="6" y1="3" x2="6" y2="15"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="6" r="3"/><path d="M18 9a9 9 0 0 1-6 6"/>',
    ...
    'graduation-cap': '<path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 3 2.5 4.5 6 4.5s6-1.5 6-4.5v-5"/>',
    'guitar': '<path d="m20 7 1.7-1.7a1 1 0 0 0 0-1.4l-1.6-1.6a1 1 0 0 0-1.4 0L17 4v3Z"/><path d="m17 7-5.1 5.1"/><circle cx="11.5" cy="12.5" r=".5" fill="currentColor"/><path d="M6 12a2 2 0 0 0 2-2c0-1.1.9-2 2-2a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2Z"/>',
    'hammer': '<path d="m15 12-8.373 8.373a1 1 0 0 1-1.414 0L3.186 18.36a1 1 0 0 1 0-1.414L11.43 8.7"/><path d="m15 12 6.29-6.29a1 1 0 0 0 0-1.414l-1.986-1.986a1 1 0 0 0-1.414 0L12 8.3"/>',
    ...
    'keyboard': '<rect width="20" height="16" x="2" y="4" rx="2"/><path d="M6 8h4"/><path d="M14 8h.01"/><path d="M18 8h.01"/><path d="M2 12h20"/><path d="M6 12v4"/><path d="M10 12v4"/><path d="M14 12v4"/><path d="M18 12v4"/>',
    ...
    'paintbrush': '<path d="M18.37 2.63a2.12 2.12 0 0 1 3 3l-1.12 1.12a2.12 2.12 0 0 1-3 3L6 20.37a2 2 0 0 1-2.83 0l-.54-.54a2 2 0 0 1 0-2.83L14.37 5.37Z"/><path d="M6 20.37 2.63 17"/><path d="m16 6 2 2"/>',
    'palette': '<circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/>',
    'party-popper': '<path d="M5.8 11.3 2 22l10.7-3.79"/><path d="M4 3h.01"/><path d="M22 8h.01"/><path d="M15 2h.01"/><path d="M22 20h.01"/><path d="m22 2-2.24.75a2.9 2.9 0 0 0-1.96 3.12c.1.86-.57 1.63-1.45 1.63h-.38c-.86 0-1.6.6-1.76 1.44L14 10"/><path d="m14 10-.66 3.1a2 2 0 0 0 1.18 2.25l2.09.9"/>',
    ...
    'syringe': '<path d="m18 2 4 4"/><path d="m17 7 3-3"/><path d="M19 9 8.7 19.3a1 1 0 0 1-1.4 0l-.6-.6a1 1 0 0 1 0-1.4L17 7"/><path d="m11 11 3 3"/><path d="m4 20 3 3"/><path d="m2 22 3-3"/>',
    'table': '<path d="M12 3v18"/><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/>',
    'list-ordered': '<line x1="10" y1="6" x2="21" y2="6"/><line x1="10" y1="12" x2="21" y2="12"/><line x1="10" y1="18" x2="21" y2="18"/><path d="M4 6h1v4"/><path d="M4 10h2"/><path d="M4 18h1v4"/><path d="M4 22h2"/>',
    ...
    'video': '<path d="m22 8-6 4 6 4V8Z"/><rect x="2" y="5" width="14" height="14" rx="2" ry="2"/>',
    ...
    'wine': '<path d="M8 22h8"/><path d="M12 11v11"/><path d="m12 2-.2.1a9 9 0 0 0-6.3 8.4c.01 1.06.4 2.08 1.1 2.9h10.8a4.98 4.98 0 0 0 1.1-2.9A9 9 0 0 0 12.2 2.1Z"/>',
  ...
  App.renderLucideSVG = function (name, width, height) {
    var paths = App.iconsData[name];
  ...
  App.renderLucideIcon = function (name) {
    var paths = App.iconsData[name];
    if (!paths) return '';
    var svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
  ...
  App.processIconShortcodes = function (html) {
    return html.replace(/:([a-z][a-z0-9-]*[a-z0-9]):/g, function (match, name) {
      return App.renderLucideIcon(name) || match;
    });
  };

  App.refreshIcons = function (container) {
    try {
      var target = container || document;
      var elements = target.querySelectorAll('[data-lucide]');
      if (elements.length === 0) return;
      Array.from(elements).forEach(function (el) {
        var name = el.getAttribute('data-lucide');
        var svg = App.renderLucideSVG(name, el.getAttribute('width'), el.getAttribute('height'));
  ...
  App.renderMarkdown = function (text) {
    if (typeof marked === 'undefined') return App.escapeHtml(text);
    return marked.parse(text || '');
  };

  App.toggleIconPicker = function () {
    if (dom.iconPicker.classList.contains('hidden')) {
      App.openIconPicker();
    } else {
      App.closeIconPicker();
    }
  ...
  App.openIconPicker = function () {
    dom.iconSearchInput.value = '';
    App.populateIconGrid(Object.keys(App.iconsData));
    dom.iconPicker.classList.remove('hidden');
    App.refreshIcons(dom.iconPicker);
    dom.iconSearchInput.focus();
  };

  App.closeIconPicker = function () {
    dom.iconPicker.classList.add('hidden');
  };

  App.populateIconGrid = function (names) {
    dom.iconPickerGrid.innerHTML = '';
    names.forEach(function (name) {
      var item = document.createElement('div');
      item.className = 'icon-picker-item';
      item.title = name;
      item.innerHTML = App.renderLucideIcon(name);
      item.addEventListener('click', function () {
        App.insertMarkdownAtCursor(':' + name + ':');
        dom.noteContent.focus();
        App.scheduleSave();
        App.closeIconPicker();
      });
      dom.iconPickerGrid.appendChild(item);
    });
  };

  App.filterIconPicker = function () {
    var q = dom.iconSearchInput.value.trim().toLowerCase();
    var names = Object.keys(App.iconsData);
    if (q) {
      names = names.filter(function (n) { return n.indexOf(q) !== -1; });
    }
    App.populateIconGrid(names);
    App.refreshIcons(dom.iconPickerGrid);
  };
})();
